...
################################################################################
ifndef SDLGUI_ROOT
    SDLGUI_ROOT =$(realpath ../../..)
endif

#ifndef SDLGUI_LIBS_PATH
    SDLGUI_LIBS_PATH = $(SDLGUI_ROOT)/libs
#endif

#ifndef SDLGUI_SRC_PATH
    SDLGUI_SRC_PATH = $(SDLGUI_ROOT)/SDL_gui
#endif
...
BYTECODECORE=1
PLATFORM_CORELIB_DEBUG_TARGET =
PLATFORM_CORELIB_RELEASE_TARGET =
...
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/SDL_gui.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/GUI_utils.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/GUI_WinBase.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/GUI_MainWin.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/GUI_TopWin.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/GUI_BasicWidgets.cpp
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_SRC_PATH)/jsFileUtils.cpp

# third party
PLATFORM_CORE_EXCLUSIONS += $(SDLGUI_LIBS_PATH)/boost/include/boost/%
